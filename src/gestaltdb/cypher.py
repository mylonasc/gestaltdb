...
from .cypher_plan import CreateStep, DeleteStep, LogicalPlan, MergeStep, RemoveStep, SetStep, plan_query, plan_staged_query, plan_union_query
...
def _plan_has_writes(plan: LogicalPlan) -> bool:
    ...
    return any(isinstance(operator, (CreateStep, MergeStep, SetStep, RemoveStep, DeleteStep)) for operator in plan.operators)
